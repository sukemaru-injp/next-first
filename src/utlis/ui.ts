...
export const works: WorkDetail[] = [
  {
    name: '株式会社エイチ',
    description: [
      '叡知オフィスクラウドというBtoBプロダクトで、コワーキングスペース・会議室の利用予約システム、利用後の経費精算などを一括精算するシステム開発や、社内CS・セールスの利用する社内システム開発など様々なエンドユーザーに向けての開発を経験。',
      '新規機能開発や新規サービス企画や仕様策定・設計から携わり、コンポーネント設計から開発・テスト・運用まで。',
      '2021年12月より新プロジェクト「叡知トリップ」の開発携わり、出張先の宿泊施設の利用予約システムのUI/UXの構築、開発を行いました。',
    ],
...

  {
    name: 'Alp.inc',
    description: [
      'Scalebase - サブスクリプションビジネスにおける、プライシング設計・商品管理・顧客管理・契約管理・請求管理などを行うSaaS開発。',
      '主にフロントエンドの開発に従事。React/react-router/Typescript/emotionなど',
    ],
